    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-header">Chamadas não atendidas
                </div>
                    ...
                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="badge badge-danger">Não atendido</div>
                            </td>
                            <td class="text-center">
                                <font color=red>16/04/2020 às 18:01</font>
                            </td>
                            </tr>
                        </tbody>
                    </table>
