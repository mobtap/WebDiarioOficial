...
<head>
    ...
    <title>Cadastro - Tele-Medicina    |    Ibitech software</title>
                    ...
                    <div class="d-none d-lg-block col-lg-4" >
                        <div class=" slider-light " >
							...
							<div class="slick-slide slick-cloned  " data-slick-index="-1" aria-hidden="true" tabindex="-1" style="width: 450px;">
								...
								<div class="  slick-slide slick-current slick-active " data-slick-index="0" aria-hidden="false" role="tabpanel" id="slick-slide00" style="width: 450px;" aria-describedby="slick-slide-control00"><div><div style="width: 100%; display: inline-block;">
                                    <div class="  position-relative h-100 d-flex justify-content-center align-items-center bg-plum-plate" tabindex="-1">
                                        <div class="  slide-img-bg" style="background-image: url('https://www.vmsoft.com.br/assets/images/fundo.png');background-position:-150px;"></div>
                                        <div class="  slider-content"><h3>Tele-Medicina</h3>
                                            <p>Atendimento Online com os melhores profissionais, sempre ao seu dispor, no conforto de sua casa.</p></div>
                                    </div>
